...
describe("tamper protection", () => {
  it("rejects tampered ciphertext", async () => {
    ...
    logTestStep("tamper.ciphertext", {
      original: summarizeToken(token),
      tampered: summarizeToken(tampered),
  ...
  it("rejects token used with the wrong purpose", async () => {
    ...
    logTestStep("tamper.wrong-purpose", {
  ...
  it("rejects token used with the wrong audience", async () => {
    ...
    logTestStep("tamper.wrong-audience", {
      token: summarizeToken(token),
